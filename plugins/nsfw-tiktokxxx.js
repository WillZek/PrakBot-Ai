...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*[❗] ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏs ʜᴀ sɪᴅᴏ ʙᴀɴᴇᴀᴅᴏs sɪ ᴅᴇsᴇᴀ ᴀᴄᴛɪᴠᴀʀʟᴏs ᴛɪᴇɴᴇ ǫᴜᴇ sᴇʀ ᴜɴ ᴀᴅᴍɪɴɪsᴛʀᴀᴅᴏʀ /ᴇɴᴀʙʟᴇ nsfw*'
let fgif = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "5212411719888@g.us" } : {})},message: {"videoMessage": { "title":`©OFC-WILLZEK﹏✍`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `⫷᭄PRAK-BOT﹏✍`, 'jpegThumbnail': false }}}
